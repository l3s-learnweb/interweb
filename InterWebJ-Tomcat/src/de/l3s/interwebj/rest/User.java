...
public class User extends Endpoint
{
    ...
    private static void testAuthService(String connectorName) throws Exception
    {
	...
	WebResource resource = createWebResource("http://localhost:8181/InterWebJ/api/users/default/services/" + connectorName + "/auth", consumerCredentials, userCredentials);
    ...
    @SuppressWarnings("all")
    private static void testRemoveMediator() throws Exception
    {
	AuthCredentials consumerCredentials = new AuthCredentials("***REMOVED***", "***REMOVED***");
    ...
    @SuppressWarnings("all")
    private static void testRevokeService(String connectorName) throws Exception
    {
	AuthCredentials consumerCredentials = new AuthCredentials("***REMOVED***", "***REMOVED***");
	AuthCredentials userCredentials = new AuthCredentials("***REMOVED***", "***REMOVED***");
	WebResource resource = createWebResource("http://localhost:8181/InterWebJ/api/users/default/services/" + connectorName + "/auth", consumerCredentials, userCredentials);
    ...
    @SuppressWarnings("all")
    private static void testSetMediator() throws Exception
    {
	AuthCredentials consumerCredentials = new AuthCredentials("***REMOVED***", "***REMOVED***");
	AuthCredentials mediatorCredentials = new AuthCredentials("***REMOVED***", "***REMOVED***");
	AuthCredentials userCredentials = new AuthCredentials("***REMOVED***", "***REMOVED***");
    ...
    @SuppressWarnings("all")
    private static void testUserService(String connectorName) throws Exception
    {
	AuthCredentials consumerCredentials = new AuthCredentials("***REMOVED***", "***REMOVED***");
	AuthCredentials userCredentials = new AuthCredentials("***REMOVED***", "***REMOVED***");
	WebResource resource = createWebResource("http://localhost:8181/InterWebJ/api/users/default/services/" + connectorName, consumerCredentials, userCredentials);
	System.out.println("querying InterWebJ URL: " + resource.toString());
	ClientResponse response = resource.get(ClientResponse.class);
	ServiceResponse serviceResponse = response.getEntity(ServiceResponse.class);
	System.out.println(serviceResponse);
    ...
    @SuppressWarnings("all")
    private static void testUserServices() throws Exception
    {
	AuthCredentials consumerCredentials = new AuthCredentials("***REMOVED***", "***REMOVED***");
