...
public class PictureInfo
{
    ...
    public PictureInfo(String id, Hashtable<String, Double> features, TreeMap<String, Vector<ExplainedWeightedFeature>> usedFeatures, TreeMap<String, Vector<ExplainedWeightedFeature>> allfeatures, Hashtable<String, TreeMap<String, Double>> suggestedtags, Double svmlightResult,
	    Double svmlightResultProbabilty, String label, String filename, PictureError error)
    {
	super();
	this._id = id;
    ...
    public PictureInfo(String id, String title, String tags, String description, String filename, String imageurl)
    {
	this._id = id;
	this._filename = filename;
	this._tags = tags;
