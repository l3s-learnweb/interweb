...

{
	...
	private class UserResultRetriever implements Callable<UserSocialNetworkResult>
	{
		...
		public UserResultRetriever(ServiceConnector connector,
	...
	public void addSocialNetworkRetriever(ServiceConnector connector,
	                                    AuthCredentials authCredentials)
	{
	...
	public UserSocialNetworkResult retrieve()
