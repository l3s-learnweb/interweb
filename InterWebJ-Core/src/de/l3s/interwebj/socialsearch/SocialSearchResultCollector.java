...

{
	...
	private class SocialSearchResultRetriever implements Callable<SocialSearchResult>
	{
		...
		public SocialSearchResultRetriever(ServiceConnector connector,
		...
		public SocialSearchResult call() throws Exception
		{
			...
			Environment.logger.info("[" + connector.getName() + "] Finished. ["
			                        + SocialSearchResult.getResultItems().size()
			                        + " of total "
			                        + SocialSearchResult.getTotalResultCount()
			                        + "] result(s) found in ["
	...
	public void addSocialSearchResultRetriever(ServiceConnector connector,
	                                    AuthCredentials authCredentials)
	{
	...
	public SocialSearchResult retrieve()
