...
const openai = new OpenAI({
  baseURL: 'https://interweb.l3s.uni-hannover.de/v1/',
  apiKey: 'INTERWEB_API_KEY',
})
...
``` shell
curl https://interweb.l3s.uni-hannover.de/v1/chat/completions \
...
curl https://interweb.l3s.uni-hannover.de/v1/completions \
    -H "Content-Type: application/json" \
    -d '{
        "model": "llama3.1:8b",
        "prompt": "Say this is a test"
...
curl https://interweb.l3s.uni-hannover.de/v1/models

curl https://interweb.l3s.uni-hannover.de/v1/models/llama3.1:8b

curl https://interweb.l3s.uni-hannover.de/v1/embeddings \
    -H "Content-Type: application/json" \
    -d '{
        "model": "all-minilm",
        "input": ["why is the sky blue?", "why is the grass green?"]
