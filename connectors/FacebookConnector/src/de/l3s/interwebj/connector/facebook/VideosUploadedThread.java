...
class VideosUploadedThread extends Thread {
	String userid;
	Facebook fbapi;
	IndexWriter writer;
	Videolist videosuploaded;
    public VideosUploadedThread(String str) {
	super(str);
    }
    public VideosUploadedThread(String threadname, String userid, Facebook fbapi, IndexWriter writer)
    {
    	super(threadname);
    	 this.userid= userid;
    ...
    public void run() {
    	System.out.println(getName()+videosuploaded.getData().size());
