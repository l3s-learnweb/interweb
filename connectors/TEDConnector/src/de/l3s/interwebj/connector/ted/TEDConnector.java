...
{	
	public TEDConnector(Configuration configuration)
	{
		this(configuration, null);
	}	

	public TEDConnector(de.l3s.interwebj.config.Configuration configuration, AuthCredentials consumerAuthCredentials)
	{
		super(configuration);
	...
	{
		return new TEDConnector(getConfiguration(), getAuthCredentials());
	}	
...
/*
	...
	public QueryResult get(Query query, AuthCredentials authCredentials) throws InterWebException
	{
		...
		WebResource resource = createWebResource("https://api.datamarket.azure.com/Data.ashx/Bing/SearchWeb/v1/Web", a);//getAuthCredentials());
