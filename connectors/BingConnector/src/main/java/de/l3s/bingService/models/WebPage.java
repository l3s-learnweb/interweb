...
public class WebPage {
    ...
    public String toString() {
        return new ToStringBuilder(this)
            ...
            .append("name", name)
            .append("url", url)
            .append("isFamilyFriendly", isFamilyFriendly)
            .append("displayUrl", displayUrl)
            .append("snippet", snippet)
            .append("urlPingSuffix", urlPingSuffix)
            .append("deepLinks", deepLinks)
            .append("dateLastCrawled", dateLastCrawled)
            .append("language", language)
            .append("isNavigational", isNavigational)
            .toString();
    }
}
