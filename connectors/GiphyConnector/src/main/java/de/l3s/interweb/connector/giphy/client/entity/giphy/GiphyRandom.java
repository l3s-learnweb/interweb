...
public class GiphyRandom {
     ...
     *
     * @param imageOriginalUrl the original image URL
     */
     ...
     *
     * @param imageMp4Url the image mp4 URL
     */
     ...
     *
     * @param fixedHeightDownsampledHeight the fixed height downsampled height
     */
     ...
     *
     * @param fixedWidthDownsampledUrl the fixed width downsampled URL
     */
     ...
     *
     * @param fixedWidthDownsampledWidth the fixed width downsampled width
     */
     ...
     *
     * @param fixedWidthDownsampledHeight the fixed width downsampled height
     */
     ...
     *
     * @param fixedHeightSmallUrl the fixed height small URL
     */
     ...
     *
     * @param fixedHeightSmallStillUrl the fixed height small still URL
     */
     ...
     *
     * @param fixedHeightSmallWidth the fixed height small width
     */
     ...
     *
     * @param fixedHeightSmallHeight the fixed height small height
     */
     ...
     *
     * @param fixedWidthSmallUrl the fixed width small height
     */
     ...
     *
     * @param fixedWidthSmallStillUrl the fixed width small still URL
     */
     ...
     * Sets the fixed width small height.
     *
     * @param fixedWidthSmallWidth the fixed width small height
     */
     ...
     * Sets the fixed width small height.
     *
     * @param fixedWidthSmallHeight the fixed width small height
     */
