...
public class PlacesInterface
{
     ...
     * city that contains the point rather than the street, or building, itself.
     * <p>
     *
     ...
     * level this can get messy and not always return the correct location.
     * <p>
     *
     ...
     * times it is an issue of two competing ideas of where a place "is".
     * <p>
     *
     ...
     * @param placeId A Flickr Places ID. Optional, can be null.
     * @param woeId A Where On Earth (WOE) ID. Optional, can be null.
     * @param threshold The minimum number of photos that a place type must have to be included. If the number of photos is lowered then the parent
     *            place type for that place will be used. Optional, can be null.
     ...
     * @param tagMode Either 'any' for an OR combination of tags, or 'all' for an AND combination. Defaults to 'any' if not specified. Optional, can
     *            be null.
     * @param machineTags
     * @param machineTagMode Either 'any' for an OR combination of tags, or 'all' for an AND combination. Defaults to 'any' if not specified.
     ...
     * @throws SAXException
     */
    public PlacesList placesForTags(int placeTypeId, String woeId, String placeId, String threshold, String[] tags, String tagMode, String machineTags, String machineTagMode, Date minUploadDate, Date maxUploadDate, Date minTakenDate, Date maxTakenDate)
