...
public class CommentsInterface
{
     ...
     *
     * <p>
     * There is an emphasis on the recent part with this method, which is
     * fancy-talk for "in the last hour".
     * </p>
     *
     * <p>
     * It is not meant to be a general purpose, get all the comments ever,
     * but rather a quick and easy way to bubble up photos that people are
     * talking about ("about") now.
     * </p>
     *
     * <p>
     * It has the added bonus / side-effect of bubbling up photos a person
     * may have missed because they were uploaded before the photo owner was
     * made a contact or the business of life got in the way.
     * </p>
     *
     * This method requires authentication with 'read' permission.
     *
     * @param lastComment Limits the resultset to photos that have been commented on since this date. The default, and maximum, offset is (1) hour.
