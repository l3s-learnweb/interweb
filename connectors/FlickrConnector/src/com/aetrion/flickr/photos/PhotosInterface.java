...
public class PhotosInterface
{
     ...
     * This method requires authentication with 'read' permission.
     *
     * @param minUploadDate Minimum upload date. Photos with an upload date greater than or equal to this value will be returned. Set to null to not
     *            specify a date.
     * @param maxUploadDate Maximum upload date. Photos with an upload date less than or equal to this value will be returned. Set to null to not
     *            specify a date.
     * @param minTakenDate Minimum taken date. Photos with an taken date greater than or equal to this value will be returned. Set to null to not
     *            specify a date.
     * @param maxTakenDate Maximum taken date. Photos with an taken date less than or equal to this value will be returned. Set to null to not specify
     *            a date.
     ...
     *
     * @see com.aetrion.flickr.photos.Extras
     * @param sort The order in which to sort returned photos. Deafults to date-posted-desc. The possible values are: date-posted-asc,
     *            date-posted-desc, date-taken-asc, date-taken-desc, interestingness-desc, and interestingness-asc.
     ...
     * Recently modified may mean that the photo's metadata (title, description, tags) may have been changed or a comment has been added (or just
     * modified somehow :-)
     *
     * This method requires authentication with 'read' permission.
     *
