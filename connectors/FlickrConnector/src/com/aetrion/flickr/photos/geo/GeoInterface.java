...
public class GeoInterface
{
     ...
     *
     * @param photoId Photo id (required).
     * @param context Context is a numeric value representing the photo's geotagginess beyond latitude and longitude. For example, you may wish to
     *            indicate that a photo was taken "indoors" (1) or "outdoors" (2).
     * @throws IOException
     * @throws SAXException
     * @throws FlickrException
     */
