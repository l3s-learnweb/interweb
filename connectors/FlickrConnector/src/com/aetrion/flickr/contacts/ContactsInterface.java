...
public class ContactsInterface
{
     ...
     *
     * @param lastUpload Limits the resultset to contacts that have uploaded photos since this date. The date should be in the form of a Unix
     *            timestamp. The default, and maximum, offset is (1) hour. (Optional, can be null)
     * @param filter Limit the result set to all contacts or only those who are friends or family.<br/>
     ...
     */
    public Collection getListRecentlyUploaded(Date lastUpload, String filter) throws IOException, SAXException, FlickrException
    {
	List contacts = new ArrayList();
