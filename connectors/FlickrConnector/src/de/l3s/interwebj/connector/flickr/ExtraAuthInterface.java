...
public class ExtraAuthInterface extends AuthInterface
{
    ...
    public ExtraAuthInterface(String apiKey, String sharedSecret, Transport transport, String extraParameter)
    {
	...
	parameters.add(new Parameter("api_sig", AuthUtilities.getSignature(extraSharedSecret, parameters)));
